                    ...
                    foreach ($data as $key){
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Apakah anda yakin menolak pembayaran ini?')" href="<?= base_url("administrator/pembayaran/deny/".$key->pembayaran_id)?>"class="btn btn-danger" title="tolak"><i class="fa fa-window-close"></i></a></td>
                        </tr>
                        <?php
                        $no++;
                    }
