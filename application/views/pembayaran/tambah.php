...
<div class="row">
    <div class="col-md-12">
        <form action="<?= base_url('administrator/pembayaran/tambah')?>" method="post" data-parsley-validate="" novalidate="" class="form-horizontal">
            <!-- START panel-->
                ...
                <div class="panel-body">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="pembayaran_nama" required="required" placeholder="nama" class="form-control">
                            </div>
                        </div>
                    </fieldset>
