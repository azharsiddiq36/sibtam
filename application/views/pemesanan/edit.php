...
<div class="row">
    <div class="col-md-12">
        <form action="<?= base_url('administrator/pemesanan/edit/'.$row['pemesanan_id'])?>" method="post" data-parsley-validate="" novalidate="" class="form-horizontal">
            <!-- START panel-->
                ...
                <div class="panel-body">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="pemesanan_nama" required="required" value="<?= $row['pemesanan_nama']?>" placeholder="nama" class="form-control">
                            </div>
                        </div>
                    </fieldset>
