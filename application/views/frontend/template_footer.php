                ...
                <!-- <div class="col-sm-12 col-xl-3">
                    <div class="footer-social">
                        <ul class="social-icons">
                            ...
                            <li><a class="twitter social-icon" href="index.html#" title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
                            <li><a class="instagram social-icon" href="index.html#" title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a></li>
                            <li><a class="linkedin social-icon" href="index.html#" title="Linkedin" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                    ...
                                    <div class="col-xs-12 col-md-5 col-lg-5">
                                        <div class="single-product-info">
                                            ...
                                            <div class="wishlist-compear-area">
                                                ...
                                                <a href="index.html#"><i class="ion-ios-loop-strong"></i> Compare</a>
                                            </div>
                                            <div class="product_meta">
                                                <span class="posted_in">Categories: <a href="index.html#" rel="tag">Accessories</a>, <a href="index.html#" rel="tag">Clothings</a></span>
                                            </div>
                                            <div class="single-product-sharing">
                                                <div class="widget widget_socialsharing_widget">
                                                    <h3 class="widget-title">Share this product</h3>
                                                    <ul class="social-icons">
                                                        <li><a class="facebook social-icon" href="index.html#"><i class="fa fa-facebook"></i></a></li>
                                                        <li><a class="twitter social-icon" href="index.html#"><i class="fa fa-twitter"></i></a></li>
                                                        <li><a class="pinterest social-icon" href="index.html#"><i class="fa fa-pinterest"></i></a></li>
                                                        <li><a class="gplus social-icon" href="index.html#"><i class="fa fa-google-plus"></i></a></li>
                                                        <li><a class="linkedin social-icon" href="index.html#"><i class="fa fa-linkedin"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
<!-- jQuery Local -->
<script>window.jQuery || document.write('<script src="<?= base_url()?>assets/frontend/assets/js/jquery-3.2.1.min.js"><\/script>')</script>
...
<!-- nivo slider pack js  -->
<script src="<?= base_url()?>assets/frontend/assets/js/jquery.nivo.slider.pack.js"></script>
<!-- All plugins here -->
<script src="<?= base_url()?>assets/frontend/assets/js/plugins.js"></script>
<!-- Main js  -->
